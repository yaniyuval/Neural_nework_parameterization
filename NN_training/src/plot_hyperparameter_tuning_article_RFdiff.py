...
train_score =  [0] * len(n_estimators)
test_score = [0] * len(n_estimators)
jj = 0
do_nn = False
Output_ind1 = 2
Output_ind2 = 17
...
pickle.dump([n_estimators,train_score, test_score], open(figpath + 'Tree_sensitivity_Rsq_RF_diff' + str(Output_ind1) + '_' + str(Output_ind2) + '.pkl', 'wb'))
