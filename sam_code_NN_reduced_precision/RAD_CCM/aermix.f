...
C-----------------------------------------------------------------------
c
c $Id: aermix.f,v 1.1.1.1 2007/01/11 22:58:18 cw Exp $
c
C-----------------------------------------------------------------------
...
C Input arguments
C
      real pint(plond,plevp)   ! Rad level interface press. (dynes/cm2)
C                                    
C Output arguments                   
C                                    
      real aermmr(plond,plev)  ! Rad level aerosol mass mixing ratio
      real rh(plond,plev)      ! Rad level relative humidity (fraction)
C
C---------------------------Local variables-----------------------------
C
