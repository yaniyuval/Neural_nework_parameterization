      subroutine radini(gravx   ,cpairx  ,epsilox ,stebolx ,co2factor)
C-----------------------------------------------------------------------
C
...
C-----------------------------------------------------------------------
c
c $Id: radini.f,v 1.1.1.1 2007/01/11 22:58:18 cw Exp $
c
...
C
      ...
      real co2factor  ! Multiplier for co2 mixing ratios
C
C---------------------------Local variables-----------------------------
C
