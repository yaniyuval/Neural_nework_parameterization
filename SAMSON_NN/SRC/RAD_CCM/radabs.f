...
C-----------------------------------------------------------------------
c
c $Id: radabs.f,v 1.1.1.1 2007/01/11 22:58:18 cw Exp $
c
...
C
      ...
      real absnxt(plond,plevp,4)       ! Total nearest layer absorptivity
C
C---------------------------Local variables-----------------------------
C
...
C
      real dbvt             ! Planck fnctn tmp derivative for o3
      real t
C
...
c
c          call trcab(k1, k2, ucfc11, ucfc12, un2o0,  un2o1,
c     $                       uch4,   uco211, uco212, uco213, 
c     $                       uco221, uco222, uco223, bn2o0, 
c     $                       bn2o1,  bch4,   to3co2, pnm,
c     $                       dw,     pnew,   s2c,    uptype,
c     $                       u,      abplnk1,tco2,   th2o,   
c     $                       to3,    abstrc)
...
c
c          call trcabn(k2      ,kn      ,ucfc11  ,ucfc12  ,un2o0   ,
c     $                un2o1   ,uch4    ,uco211  ,uco212  ,uco213  , 
c     $                uco221  ,uco222  ,uco223  ,tbar    ,bplnk   , 
c     $                winpl   ,pinpl   ,tco2    ,th2o    ,to3     ,
c     $                uptype  ,dw      ,s2c     ,u       ,pnew    ,
c     $                abstrc  )
C
